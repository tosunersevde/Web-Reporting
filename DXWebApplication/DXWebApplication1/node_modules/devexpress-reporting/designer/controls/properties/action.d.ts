...
export declare class ActionsCacheManager {
    static cache: ActionTypeBase[];
    static getFromCache(predicate: (element: ActionTypeBase) => boolean): ActionTypeBase;
    static addOrUpdate(element: ActionTypeBase, predicate: (element: ActionTypeBase) => boolean): void;
}
