...
export const legendName = { propertyName: 'legendName', modelName: '@LegendName', displayName: 'Legend', localizationId: 'DevExpress.XtraCharts.ConstantLine.Legend', defaultVal: getLocalization('Default Legend', 'ChartStringId.DefaultLegend'), editor: chartEditorTemplates.getEditor('legends') };
