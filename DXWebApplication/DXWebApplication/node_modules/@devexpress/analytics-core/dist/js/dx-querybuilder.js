...
class RequestWrapper {
    sendRequest(action, arg) {
        return (0,external_DevExpress_Analytics_Internal_namespaceObject.ajax)(HandlerUri(), action, arg);
    }
    _sendRequest(settings) {
        return (0,external_DevExpress_Analytics_Internal_namespaceObject.ajax)(settings);
    }
