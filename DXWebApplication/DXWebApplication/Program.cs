...
using DXWebApplication.Services;
using DXWebApplication.Data;
...
DevExpress.Utils.DeserializationSettings.RegisterTrustedClass(typeof(DXWebApplication.Employees.DataSource));
DevExpress.Utils.DeserializationSettings.RegisterTrustedClass(typeof(DXWebApplication.Country.DataSource));
