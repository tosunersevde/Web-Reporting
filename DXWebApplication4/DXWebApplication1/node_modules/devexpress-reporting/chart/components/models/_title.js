...
const chartTitleText = { propertyName: 'text', modelName: '@Text', localizable: true, displayName: 'Text', editor: editorTemplates.getEditor('text'), localizationId: 'ASPxReportsStringId.ExportName_txt' };
export const titleSerializationsInfo = [chartTitleText, textColor, dock, titleAlignment, visibility, font18];
